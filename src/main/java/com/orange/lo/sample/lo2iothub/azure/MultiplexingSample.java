...
//        }
        ...
        args[0] = "AMQPS";
        args[1] = "orange-test.azure-devices.net";
        args[2] = "HostName=orange-test.azure-devices.net;DeviceId=urn:lo:nsid:x-connector:device_load1_1;SharedAccessKey=89aWLBdLuWTb2wF91xDRqQ==";
        args[3] = "HostName=orange-test.azure-devices.net;DeviceId=urn:lo:nsid:x-connector:device_load1_2;SharedAccessKey=egQGyQRbfu2HLI5n6Naiig==";
        args[4] = "HostName=orange-test.azure-devices.net;DeviceId=urn:lo:nsid:x-connector:device_demo_iot1_3;SharedAccessKey=FBDkOSComm35XoT00viffA==";
        args[5] = "HostName=orange-test.azure-devices.net;DeviceId=urn:lo:nsid:x-connector:device_demo_iot1_4;SharedAccessKey=vd4wLyZYGwd8Dx9MxMiPgA==";
        args[6] = "HostName=orange-test.azure-devices.net;DeviceId=urn:lo:nsid:mqtt:device_load1_5;SharedAccessKey=fMBt2PNqx5YOfl6kXwAnSQ==";
